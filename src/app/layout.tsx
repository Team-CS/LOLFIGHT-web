...
export const metadata: Metadata = {
  title: "롤파이트 | LOL.FIGHT - 롤 길드 대항전, 스크림, 내전 플랫폼",
  description:
    "롤파이트(LOLFIGHT)는 리그 오브 레전드(LoL) 유저들을 위한 내전, 스크림, 길드 대항전 커뮤니티 플랫폼입니다. 롤 커스텀 매치부터 길드전까지, 롤파이트에서 만나보세요!",
  keywords: [
    "롤파이트",
    "LOLFIGHT",
    "롤 내전",
  ...
  openGraph: {
    title: "롤파이트 | LOL.FIGHT - 롤 길드 대항전, 스크림, 내전 플랫폼",
    description:
      "리그 오브 레전드 내전과 스크림을 위한 최고의 플랫폼, 롤파이트(LOLFIGHT)! 길드전, 커스텀 매치 등 LoL 커뮤니티 기능 제공.",
